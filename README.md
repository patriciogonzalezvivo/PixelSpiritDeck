...
PixelSpirt **open a call for new or remixed cards** until the 1st of December, be part of the new **COLLECTIVE** deck and win a free deck! 

Selected cards will be printed in a extension deck which 100% of the profits will be donated to [ACLU](https://www.aclu.org/). 

Cards must be submitted before the 1st of December of 2017 and:

- use only the functions presented on PixelSpirit **ELEMENTS** deck. [Check the available functions here](https://github.com/patriciogonzalezvivo/PixelSpiritDeck/tree/master/lib)

- use only black and white colors.

- be geometrical symbols with personal meaning for you.

- code needs to be as short and compact as possible, so it can fit the back of a card.

- all tags must be filled

```
    // Title: Card Name
    // Author: Your Name
    // Contact: Your Twitter, Mail, FB or IG account
    // Description: What this card means to you?
```
- code will be submitted throw as a public message to the [twitter @pixelspiritdeck](https://twitter.com/pixelspiritdeck?lang=en) using the url generated by [this online editor: editor.pixelspiritdeck.com/](http://editor.pixelspiritdeck.com/)  ( Click  "Share" button > "Artwork url ...". copy/paste the url in a message addressed to [@pixelspiritdeck Twitter account](https://twitter.com/pixelspiritdeck?lang=en))

- if you don't feel confortable coding you can participate submitting a design to the same [twitter account](https://twitter.com/pixelspiritdeck?lang=en) and we will try to find you someone that can code it for you. [Here is a set of SVG shapes that can be recode using the **ELEMENTS** deck](https://github.com/patriciogonzalezvivo/PixelSpiritDeck/blob/master/examples_shapes/elements.svg) 
